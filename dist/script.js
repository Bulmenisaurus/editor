...
(() => {
  ...
  var DEBUG = new URL(window.location.toString()).searchParams.has("debug");
  var getFileInfo = async () => {
    if (DEBUG)
  ...
  var main = () => {
    ...
    let currentFileInfo = void 0;
    fileChooseButton.addEventListener("click", async () => {
      if (currentFileInfo != void 0) {
